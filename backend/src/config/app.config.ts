...
export default registerAs('app', () => ({
  ...
  defaultReservationMinutes: parseInt(
    process.env.DEFAULT_RESERVATION_MINUTES ?? '10',
    10,
  ),
  ...
  paystackWebhookSecret:
    ...
    '',
  paymentTestEndpointsEnabled:
    process.env.PAYMENT_TEST_ENDPOINTS_ENABLED === 'true',
