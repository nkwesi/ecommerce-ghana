...
export function Footer() {
  return <footer className="site-footer">
    <div><div className="footer-mark">GHANA<span>STYLE</span></div><p>Considered clothing for life in motion.<br/>Designed in Ghana.</p></div>
    ...
    <small>© {new Date().getFullYear()} GhanaStyle. Mock catalog for launch preparation.</small>
  </footer>;
}
