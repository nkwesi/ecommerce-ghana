...
export default function Home() {
  ...
  return <>
    ...
    <section className="story-banner"><div className="story-image"><Image src="/products/dress.png" alt="Black midi dress" fill sizes="50vw" /></div><div className="story-copy"><p className="eyebrow">The Drobe 233 approach</p><h2>Less noise.<br/>Better clothes.</h2><p>We build wardrobes around versatile silhouettes, considered materials, and pieces you will reach for again and again.</p><Link className="text-link" href="/shop">Discover the edit <ArrowIcon /></Link></div></section>
